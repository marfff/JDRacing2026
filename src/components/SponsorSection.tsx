...
export default function SponsorSection() {
  ...
  return (
    <section
      id='sponsor'
      className='bg-[#060606] border-t border-white/5 py-20 px-6'>
      <div
        ref={ref}
        ...
        <div className='text-center mb-14'>
          <div className='flex items-center justify-center gap-3 mb-5'>
            ...
            <span className='text-[10px] tracking-[0.5em] text-[#00F5FF] uppercase font-medium'>
              Partner with James
            </span>
            <div className='h-[1px] w-8 bg-[#00F5FF]' />
          </div>
          ...
          <p className='text-white/55 text-sm max-w-lg mx-auto leading-relaxed'>
            Your brand on the kart, on social media, and part of a young
            driver's journey to the European Championships. Pick a tier and
            click — it opens a pre-filled email straight to the team.
          </p>
        </div>
